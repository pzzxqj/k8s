...
#
# Values here are defaults; group data (learning.py / production.py) and per-host
# data in the inventories override them (see data hierarchy in the pyinfra docs).
...
# kubeadm / cluster defaults (learning and production share them today).
apiserver_port = "6443"
