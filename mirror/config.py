...
internal client — the k8s production and test clusters just happen to consume
...
# test cluster's repo sources are these upstreams; production's are the
# mirror URLs derived from MIRROR_HOST (see group_data/k8s_production.py).
K8S_MINOR = "1.36"
